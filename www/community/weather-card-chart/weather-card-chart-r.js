...
class WeatherCardChart extends Polymer.Element {
        ...
        <div class="card">
          ...
          <div class="attributes" on-click="_weatherAttr">
            <div>
              ...
              <ha-icon icon="[[obj1.attributes.icon]]"></ha-icon> [[obj1.state]] [[obj1.attributes.unit_of_measurement]]
            </div>
            <div>
              <template is="dom-if" if="[[sunObj]]">
                <ha-icon icon="mdi:weather-sunset-up"></ha-icon> [[computeTime(sunObj.attributes.next_rising)]]<br>
                <ha-icon icon="mdi:weather-sunset-down"></ha-icon> [[computeTime(sunObj.attributes.next_setting)]]<br>
                <ha-icon icon="[[obj2.attributes.icon]]"></ha-icon> [[obj2.state]] [[obj2.attributes.unit_of_measurement]]
                </template>
            </div>
            <div>
              <ha-icon icon="[[getWindDirIcon(windBearing)]]"></ha-icon> [[getWindDir(windBearing)]]<br>
              <ha-icon icon="hass:weather-windy"></ha-icon> [[computeWind(weatherObj.attributes.wind_speed)]] [[ll('uSpeed')]]<br>
              <ha-icon icon="[[obj3.attributes.icon]]"></ha-icon> [[obj3.state]] [[obj3.attributes.unit_of_measurement]]
            </div>
          </div>
  ...
  setConfig(config) {
    ...
    this.obj1 = config.obj1;
    this.obj2 = config.obj2;
    this.obj3 = config.obj3;
  }
  ...
  set hass(hass) {
    ...
    this.obj1 = this.config.obj1 in hass.states ? hass.states[this.config.obj1] : null;
    this.obj2 = this.config.obj2 in hass.states ? hass.states[this.config.obj2] : null;
    this.obj3 = this.config.obj3 in hass.states ? hass.states[this.config.obj3] : null;
  }
